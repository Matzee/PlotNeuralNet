...
\draw [connection]  (pool_b5-east)    -- node {\midarrow} (ccr_bottle-west);

\pic[shift={ (2.1,0,0) }] at (ccr_bottle-east) 
    {Box={
        name=unpool_b6,
        caption= ,
        fill=\UnpoolColor,
...
\draw [connection]  (ccr_bottle-east)    -- node {\midarrow} (unpool_b6-west);
