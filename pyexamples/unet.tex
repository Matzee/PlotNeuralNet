...
\node[canvas is zy plane at x=0] (temp) at (-3,0,0) {\includegraphics[width=8cm,height=8cm]{../examples/input.PNG}};
...
\draw [connection]  (end_b9-east)    -- node {\midarrow} (soft1-west);
    ...
    \node[canvas is zy plane at x=3] (temp) at (soft1-east) {\includegraphics[width=8cm,height=8cm]{../examples/output.PNG}}; 
